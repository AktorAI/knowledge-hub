...
/**
 * ConnectorAdminRouteGuard - Ensures user is a business admin for connector access
 * Redirects non-admins to personal profile instead of company profile
 */
...
/**
 * BusinessConnectorAdminRoute - Route accessible only to business admins for connector management
 * Uses ConnectorAdminRouteGuard which redirects non-admins to personal profile
 */
            ...
            children: [
              ...
              // Business Admin Settings
              {
                ...
                children: [
                  ...
                  // Connector Settings (Admin only - non-admins redirected to personal profile)
                  {
                    path: 'connector',
                    children: [
                      {
                        index: true,
                        element: <BusinessConnectorAdminRoute component={ConnectorSettings} />,
                      },
                      {
                        path: 'registry',
                        element: <BusinessConnectorAdminRoute component={ConnectorRegistry} />,
                      },
                      {
                        path: 'oauth/callback/:connectorId',
                        element: <BusinessConnectorAdminRoute component={ConnectorOAuthCallback} />,
                      },
                      {
                        path: ':connectorId',
                        element: <BusinessConnectorAdminRoute component={ConnectorManagementPage} />,
                      },
                    ],
                  },
